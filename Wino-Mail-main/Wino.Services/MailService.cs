...
public class MailService : BaseDatabaseService, IMailService
{
    ...
    public async Task<List<MailCopy>> GetUnanalyzedMailsAsync(Guid accountId)
    {
        var query = new Query(nameof(MailCopy))
                        ...
                        .Where($"{nameof(MailCopy)}.IsAIAnalyzed", false)
                        .SelectRaw($"{nameof(MailCopy)}.*")
                        .GetRawQuery();
    ...
    public async Task<MailCopy> GetMailAsync(string mailId)
    {
        var mail = await Connection.Table<MailCopy>().FirstOrDefaultAsync(m => m.Id == mailId);
    ...
    public async Task<List<MailCopy>> GetMailsByCategoryAsync(Guid accountId, AIMailCategory category)
    {
        var query = new Query(nameof(MailCopy))
                        .Join(nameof(MailItemFolder), $"{nameof(MailCopy)}.FolderId", $"{nameof(MailItemFolder)}.Id")
                        .Where($"{nameof(MailItemFolder)}.MailAccountId", accountId)
                        .Where($"{nameof(MailCopy)}.AICategory", (int)category)
    ...
    public async Task<List<MailCopy>> GetImportantMailsAsync(Guid accountId)
    {
        var query = new Query(nameof(MailCopy))
                        .Join(nameof(MailItemFolder), $"{nameof(MailCopy)}.FolderId", $"{nameof(MailItemFolder)}.Id")
                        .Where($"{nameof(MailItemFolder)}.MailAccountId", accountId)
    ...
    public async Task<List<MailCopy>> GetSpamMailsAsync(Guid accountId)
    {
        var query = new Query(nameof(MailCopy))
                        .Join(nameof(MailItemFolder), $"{nameof(MailCopy)}.FolderId", $"{nameof(MailItemFolder)}.Id")
                        .Where($"{nameof(MailItemFolder)}.MailAccountId", accountId)
