...
public interface IFolderService
{
    ...
    Task CreateAIFoldersForAccountAsync(Guid accountId);

    /// <summary>
    /// 获取AI重要邮件数量
    /// </summary>
    /// <param name="accountId">账户ID</param>
    Task<int> GetAIImportantMailCountAsync(Guid accountId);
    ...
    Task<int> GetAICategoryMailCountAsync(Guid accountId, SpecialFolderType categoryType);

    /// <summary>
    /// 获取垃圾邮件数量
    /// </summary>
    /// <param name="accountId">账户ID</param>
    Task<int> GetAISpamMailCountAsync(Guid accountId);
